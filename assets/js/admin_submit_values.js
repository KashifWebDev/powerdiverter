function turn_device_on_off(id, new_value){
    $.ajax({
        ...
        type:"POST",
        url:'ajax/admin_submit_details.php',
        data:{
...
function wireless_connection(id, new_value, state_block){
    $.ajax({
        ...
        success:function(responsedata){
            ...
            var newHtml =
                ...
                '        <a href="#" onclick="wireless_connection(\''+id+'\', \'WiFi\', \''+ state_block +'\')" class="text-white text-decoration-none">\n' +
                ...
                '    </div>\n' +
                '    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">\n' +
                '        <a href="#" onclick="wireless_connection(\''+id+'\', \'3G\', \''+ state_block +'\')" class="text-white text-decoration-none">\n' +
                ...
                '        <a href="#" onclick="wireless_connection(\''+id+'\', \'4G\', \''+ state_block +'\')" class="text-white text-decoration-none">\n' +
                ...
                '    </div>\n' +
                '    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3 mt-sm-2 mt-md-0 mt-lg-0 mt-xl-0">\n' +
                '        <a href="#" onclick="wireless_connection(\''+id+'\', \'LORA\', \''+ state_block +'\')" class="text-white text-decoration-none">\n' +
                ...
                '</div>';
            if(responsedata){
                console.log(state_block);
                document.getElementById(state_block).innerHTML = newHtml;
            }
        }
    })
...
function relay_operation(id, new_value, state_block){
    console.log(id + new_value + state_block);
    $.ajax({
        type:"POST",
        url:'ajax/admin_submit_details.php',
        data:{
        ...
        success:function(responsedata){
            ...
            var newHtml =
                '<div class="card-body">\n' +
                '   <div class="row">\n' +
                '    <div class="col-sm-6 col-md-6 col-lg-6 cardbody-auto-width">\n' +
                '        <a href="#" onclick="relay_operation(\''+id+'\', \'OFF\', \''+ state_block +'\')" class="text-white text-decoration-none">\n' +
                '            <div class="'+off_class+'">\n' +
                '                <div class="card-body p-2">\n' +
                '                    Off Peak\n' +
                '                </div>\n' +
                ...
                '    </div>\n' +
                '    <div class="col-sm-6 col-md-6 col-lg-6 cardbody-auto-width">\n' +
                '        <a href="#" onclick="relay_operation(\''+id+'\', \'ON\', \''+ state_block +'\')" class="text-white text-decoration-none">\n' +
                '            <div class="'+on_class+'">\n' +
                '                <div class="card-body p-2">\n' +
                '                    Main\n' +
                '                </div>\n' +
